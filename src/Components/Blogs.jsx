        ...
        <div className={`blogs-right-form ${showForm ? 'visible': 'hidden'}`}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <label htmlFor="file-upload" className="file-upload">
                <i class='bxr  bx-folder-up-arrow'  ></i> 
              Upload Image
            </label>
            <input 
              type="file" 
              ...
              style={{ display: 'none' }} // Optional: hide the default file input
            />
          </div>
            ...
            <textarea placeholder='Add Text' className={`text-input ${!contentValid ? 'invalid' : ''}`} value={content} onChange={handleContentChange}></textarea>
